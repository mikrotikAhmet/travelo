...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="Travelo - home" href="index-2.html"><img alt="" src="images/logo.png"></a></h1>').insertBefore('.chaser .menu');
    ...
    tjq("#style-changer .button").on("click", function(e) {
        ...
        mainStyle = mainStyle.substring(0, mainStyle.lastIndexOf("http://www.soaptheme.com/") + 1) + "style-" + colorSkin + ".css";
